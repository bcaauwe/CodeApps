...
export interface GlobalCountryHolidaysBase {
  ID?: number;
  Title: string;
  Date?: string;
  Holiday?: string;
...
export interface GlobalCountryHolidaysRead extends GlobalCountryHolidaysBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface GlobalCountryHolidaysWrite extends GlobalCountryHolidaysBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
