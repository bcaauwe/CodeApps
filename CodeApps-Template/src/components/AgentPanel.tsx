                    ...
                    {msg.type === 'agent' ? (
                      <ReactMarkdown
                        ...
                        components={{
                          ...
                          table: ({ ...props }) => <div style={{ overflowX: 'auto', marginTop: '8px', marginBottom: '8px' }}><table style={{ borderCollapse: 'collapse', width: '100%', fontSize: '0.9em', minWidth: 'max-content' }} {...props} /></div>,
